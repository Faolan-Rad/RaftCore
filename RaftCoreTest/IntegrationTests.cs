...
public class IntegrationTests
{
    ...
    **********************************/
    ...
    public void TestLogReplicationDictionary()
    {
        ...
        int nodeCount = 3;
        RaftNode<uint, string>[] nodes = TestMethods.ConfigureAndRunRaftCluster(nodeCount, SM.Dictionary);
    ...
    **********************************/
    ...
    public void TestNumeralStateMachineReplication()
    {
        // Goes further and tests state machine
        int nodeCount = 3;
        RaftNode<uint, string>[] nodes = TestMethods.ConfigureAndRunRaftCluster(nodeCount, SM.Numeral);
    ...
    **********************************/
    ...
    {
        RaftNode<uint, string>[] nodes = TestMethods.ConfigureAndRunRaftCluster(5000, SM.Dictionary);
